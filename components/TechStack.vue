<template>
  <div id="tech" class="mt-10">
    <div class="w-1/2 mx-auto text-center">
      <div class="mt-5 mx-auto text-2xl font-normal text-gray-900">
        Technology
      </div>
      <div class="border-b-2 border-red-400 w-24 mx-auto mt-2"></div>
    </div>
    <div class="mt-10 w-6/12 mx-auto">
      <div class="grid grid-cols grid-cols-4">
        <div
          class="col-span-1 w-40 h-36 mr-5 border border-gray-200 rounded rounded-xl px-4 hover:bg-gray-50"
        >
        ...
        <div
          class="col-span-1 w-40 h-36 pt-6 overflow-hidden mr-5 border border-gray-200 rounded rounded-xl px-4 hover:bg-gray-50"
        >
          <a target="_blank" href="https://golang.org"
            ><img
        ...
        <div
          class="col-span-1 w-40 h-36 pt-12 overflow-hidden mr-5 border border-gray-200 rounded rounded-xl px-4 hover:bg-gray-50"
        >
          <a target="_blank" href="https://golang.org"
            ><img
